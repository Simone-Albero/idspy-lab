...
class SemiSupervisedClassifier(Experiment):
    ...
    def __init__(self, cfg: DictConfig) -> None:
        ...
        self.log_dir = f"{cfg.path.logs}/semi_supervised_classifier{"_bg" if not cfg.experiment.exclude_background else ""}/{cfg.stage}_{ts}"
    ...
    def pretraining(self, cfg: DictConfig, storage: DictStorage) -> None:
        ...
        setup_pipeline = ObservablePipeline(
            steps=[
                ...
                BuildLoss(
                    loss_name=cfg.pretraining.loss.name,
                    loss_args=cfg.pretraining.loss.args,
                ),
                BuildOptimizer(
    ...
    def training(self, cfg: DictConfig, storage: DictStorage) -> None:
        ...
        preparing_pipeline = ObservablePipeline(
            steps=[
                BuildModel(
                    model_name=cfg.pretraining.model.name,
                    model_args=cfg.pretraining.model.args,
